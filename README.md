# App-Marketing
<p>
Im Rahmen des Wahlpflichtfaches App Marketing bei Herrn Speck habe ich mich mit den folgenden Aufgaben beschäftigt: Google Maps - Mapping App, Custom Open Street Map (Bicycle), Bluetooth Hear Rate App
  </p>
<p>
